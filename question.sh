...
#
sed 's/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9]\)/20\3-\2-\1/g' data.csv | sed 's/\([0-9]\)\/\([0-9]\)\/\([0-9][0-9][0-9][0-9]\)/\3-0\2-0\1/g' | sed 's/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9]\)/20\3-\2-\1/g' | sed 's/\([0-9]\)\/\([0-9]\)\/\([0-9][0-9][0-9][0-9]\)/\3-0\2-0\1/g' |  sed 's/\(;;\)/;\\N;/g' | sed 's/\(;n\)/;\\N/g' | sed 's/\(;\)/;\\N/3g' | sed 's/\(\\N\\N\)/\\N/g' | sed -e 's/\(\\N1\)/1/g' -e 's/\(\\N2\)/2/g' | sed 's/\(;\)/,/g' | sed 's/\(,\)/./4g' | sed -e 's/\(a\)/A/g' -e 's/\(b\)/B/g' -e 's/\(c\)/C/g' | sed 's/\(n,3\)/\N,3/1g' | sed 's/\(N,1,\)/\\N,1,/1g' 
